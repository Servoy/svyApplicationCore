...
function createProperty(name, propertySet, applicationId, sortOrder, adminLevel, header) {
	...
	if (!scopes.svyDataUtils.datasourceHasValue(fs, "property_name", name, ["svy_property_sets_id"], [propertySetId]))	{
	...
	if (adminLevel >= 0 && scopes.svyJSUtils.objectHasValue(scopes.svySecurityManager.ADMIN_LEVEL, adminLevel)) {
...
function Property(propertyRecord) {
		...
		set: function(x) {
			if (x) {
				if (record.property_name != x) {
					if (!scopes.svyDataUtils.datasourceHasValue(record, "property_name", x)) {
	...
	Object.defineProperty(this, "securityLevel", {
		...
		set: function(x) {
			if (scopes.svyJSUtils.objectHasValue(scopes.svySecurityManager.ADMIN_LEVEL, x)) {
	...
	Object.defineProperty(this, "name", {
		...
		set: function(x) {
			if (x != record.name) {
				...
				if (!scopes.svyDataUtils.datasourceHasValue(fs, "name", x))	{
