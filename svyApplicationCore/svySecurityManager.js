 ...
 * 
 * @final
 * @properties={typeid:35,uuid:"04ABD826-06C2-4064-8DF1-2D2893AF79BA",variableType:-4}
 */
var ADMIN_LEVEL = { NONE: 0, OWNER_MANAGER: 1, APPLICATION_MANAGER: 2, DEVELOPER: 3, TENANT_MANAGER: 4};
 ...
 * @type {Boolean}
 *
 * @properties={typeid:35,uuid:"CB140DA4-E563-43C9-A2A4-A1D959A35A5C",variableType:-4}
 */
 ...
 * @since 02.08.2012
 * 
 * @properties={typeid:24,uuid:"DB2C501B-0FAA-4AB9-B478-C6194B0A60C5"}
 */
function getGroups() {
	/** @type {Array<Group>} */
 ...
 * @since 02.08.2012
 *
 * @properties={typeid:24,uuid:"50BDEC4A-6A07-4A68-882E-4F7A08E174E8"}
 */
 ...
 * @since 18.09.2012
 *
 * @properties={typeid:24,uuid:"ACE56682-2F46-4A52-B19C-33A489BAC339"}
 */
 ...
 *
 *
 * @properties={typeid:24,uuid:"D21FFE16-53BB-4BF3-9CD4-2E2A55485FA2"}
 */
 ...
 * @since 13.08.2012
 *
 * @properties={typeid:24,uuid:"9BE20D8F-D0F9-446A-ABE4-A1BA58102558"}
 */
 ...
 * @since 01.08.2012
 * 
 * @properties={typeid:24,uuid:"B790BA40-9593-4C48-9C1B-40E16687C372"}
 */
function getOwners() {
	/** @type {Array<Owner>} */
 ...
 * @since 14.08.2012
 *
 * @properties={typeid:24,uuid:"1802B67C-B691-45E9-965F-585A82C79235"}
 */
 ...
 * @since 14.08.2012
 *
 * @properties={typeid:24,uuid:"A96E6FFD-4267-4357-BD9A-474412EE87B9"}
 */
function getOwnerById(ownerId) {
	...
	if (foundset.getSize() == 1) {
		ownerRecord = foundset.getRecord(1);
	}
	return new Owner(ownerRecord);
}
 ...
 * @since 01.08.2012
 *
 * @properties={typeid:24,uuid:"39917473-CA63-4960-8324-225CD26DE54E"}
 */
 ...
 * @since 13.08.2012
 * 
 * @properties={typeid:24,uuid:"CC759F62-E59C-4D45-889A-23969DB1F1B0"}
 */
function getUsers() {
	/** @type {QBSelect<db:/svy_framework/sec_user>} */
	var query = databaseManager.createSelect("db:/" + globals.nav_db_framework + "/sec_user");
 ...
 * @since 10.08.2012
 *
 * @properties={typeid:24,uuid:"805BF3AA-94FA-4F88-8617-07D8FDBB3CC3"}
 */
 ...
 * @since 14.08.2012
 *
 * @properties={typeid:24,uuid:"E7122DBD-06ED-41EC-B984-A43240F47476"}
 */
function createKey(name, description, owner) {
	...
	if (databaseManager.saveData(keyRecord)) {
 ...
 * @since 02.08.2012
 *
 * @properties={typeid:24,uuid:"59B692A9-6E23-40E4-9FAC-69979CE12188"}
 */
 ...
 * @since 02.08.2012
 *
 * @properties={typeid:24,uuid:"902029CA-1D23-45B7-9726-CBA514E0C9DD"}
 */
function createOwner(ownerName) {
	...
	if (!scopes.svyUtils.isValueUnique(fs,"name",ownerName)) {
		throw new scopes.svyExceptions.ValueNotUniqueException(null, "name");
	}
	
	var ownerRecord = fs.getRecord(fs.newRecord());
	ownerRecord.name = ownerName;
	if (databaseManager.saveData(ownerRecord)) {
		return new Owner(ownerRecord);
	} else {
		return null;
	}
 ...
 * @since 14.08.2012
 *
 * @properties={typeid:24,uuid:"FD218C1A-3558-45A8-A8C9-7D6333FA746B"}
 */
function createUser(userName, password, owner, organization) {
	...
	if (!databaseManager.saveData(userRecord)) {
		return null;
	}
 ...
 * @since 01.08.2012 
 * 
 * @properties={typeid:24,uuid:"BC3669FB-9DC9-4A8C-B626-14B4A0655E70"}
 */
 ...
 * @since 01.08.2012
 * 
 * @properties={typeid:24,uuid:"E4DA5AE4-B05C-433D-A9B3-1C5E7D727057"}
 */
function Group(ownerRecord) {
	...
	this.addUser = function(userToAdd, organization) {
		...
		return databaseManager.saveData(userInGroupRec);
	}
	...
	this.addKey = function(keyToAdd) {
		...
		return databaseManager.saveData(newUserRightRec);
	}
 ...
 * @since 01.08.2012 
 *
 * @properties={typeid:24,uuid:"14A1D4C6-AFED-4B72-A21E-E31241AE8939"}
 */
function Key(keyRecord) {
	...
	this.addTableSecurity = function(serverName, tableName, canRead, canInsert, canUpdate, canDelete, tracking) {
		...
		return databaseManager.saveData(secTableRecord);
	}
	...
	this.addElementSecurity = function(formName, elementName, editable, visible) {
		...
		return databaseManager.saveData(secElementRecord);
	}
 ...
 * @since 01.08.2012 
 * 
 * @properties={typeid:24,uuid:"51DB13A8-436D-4130-B9E9-814F0CF8F393"}
 */
 ...
 * @since 01.08.2012
 *
 * @properties={typeid:24,uuid:"C679ED04-5140-4F9B-8A4D-2479D285294E"}
 */
 ...
 * @since 2012-10-02
 *
 * @properties={typeid:24,uuid:"1F9286A1-319A-4A3A-817D-3AE993C177E7"}
 */
function updateSecurityHash(record, serverName, ownerName) {
	...
	} else if (globals.owner_id) {
		query.where.add(query.columns.owner_id.eq(globals.owner_id.toString()));
	}
	...
	if (utils.hasRecords(fs)) {
		...
		databaseManager.saveData(ownerRecord);
	}
}
 ...
 * @since 2012-10-02
 *
 * @properties={typeid:24,uuid:"FF4F7E24-FEA4-4DA8-A752-52E61DEEE44F"}
 */
 ...
 * 
 * @properties={typeid:24,uuid:"B4D3D461-8B05-49F9-9E85-91EE6AF0393C"}
 */
function filterOwner() {
	...
	for (var i = 0; i < tables.length; i++) {
		var success = databaseManager.addTableFilterParam(globals.nav_db_framework, tables[i], "owner_id", "IN", [ownerId, globals.zero_uuid], "owner_filter");
		if (!success) {
 ...
 * 
 * @properties={typeid:24,uuid:"09CDAC24-08E7-4197-B890-81A3BC1A3592"}
 */
 ...
 * 
 * @properties={typeid:24,uuid:"EFE80734-685F-440C-A591-FAE4B99CA5FB"}
 */
 ...
 * @since 2012-10-12
 *
 * @properties={typeid:24,uuid:"BC0A19D6-A2DF-42BF-83DF-0A4B3E1FDC3A"}
 */
 ...
 * @since 2012-10-02
 * 
 * @properties={typeid:24,uuid:"1E3BDFF1-1590-46A2-924C-261D646BACB6"}
 */
function createHash(serverName) {
	...
	var tableNames = ["sec_owner", "sec_user_in_group", "sec_user_password", "sec_user_in_group", "sec_user_right", "sec_security_key", "sec_element", "sec_table", "sec_table_filter"];
 ...
 * @since 14.08.2012
 *
 * @properties={typeid:24,uuid:"780B73B9-E3F8-482A-8A95-DF3E7CFE0C56"}
 */
 ...
 * @param {UUID|String} organizationId
 * 
 * @return {Array<String>} failedTables 
 *
 * @properties={typeid:24,uuid:"57F37ADC-7977-4CED-B38A-47C8002BEED9"}
 */
